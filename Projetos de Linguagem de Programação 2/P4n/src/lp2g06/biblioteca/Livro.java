...
public class Livro implements Serializable{  
	...
	public void setCategoria(String categoria) throws MinhasExcecoes{
		...
		if (meuLivro == null)
			throw new MinhasExcecoes("A categoria do livro citada nao existe na biblioteca.\nLembre-se de que as categorias são: [ROMANCE, FANTASIA, FICCAO, SUSPENSE, AVENTURA, DRAMA, TERROR]");
		this.categoria = meuLivro;
	}
	
	public void setCopias(int copias) throws MinhasExcecoes {
		if (copias <= 0)
			throw new MinhasExcecoes("Quantidade de copias nao pode ser um numero negativo ou zero.");
		this.copias = copias;
	}
