...
public class ValidaData {
	...
	/* Ver se uma data e valida sem se preocupar com a data mais atual do computador */
	...
	public static boolean isData(String dia, String mes, String ano) {
		if (isDia(dia) && isMes(mes) && isAno(ano)) {
            ...
            return isData(dia_numero, mes_numero, ano_numero);
        }
        else
            return false;
	...
	public static boolean isAno(int ano) {
        ...
        if (diferenca >= -120 && diferenca <= 120)
            return true;
        else
            return false;
	}
	...
	public static String toString(GregorianCalendar dataNasc) {
		if (dataNasc == null)
			return "null";
